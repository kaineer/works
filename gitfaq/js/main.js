...
/***/ function(module, exports, __webpack_require__) {
	...
	$.fn.transition = __webpack_require__(2);
	$.fn.dropdown = __webpack_require__(4);

	//
	var actions = {
	  'clone':           __webpack_require__(5),
	  'link-upstream':   __webpack_require__(25),
	  'list-remotes':    __webpack_require__(26),
	  'create-branch':   __webpack_require__(27),
	  'checkout-branch': __webpack_require__(28),
	  'stage-files':     __webpack_require__(29),
	  'cancel-changes':  __webpack_require__(30),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1 id=\"-\">Клонировать репозитарий форка</h1>\n<p>Чтобы получить на свой диск содержимое репозитария-форка\nдостаточно перейти в каталог, в котором будет находиться\nкаталог проекта и выполнить команду:</p>\n<pre><code>git clone "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.ssh : depth0)) != null ? stack1.origin : stack1), depth0))
	    + "\n</code></pre><h2 id=\"-\">Что можно сделать дальше</h2>\n<ul>\n<li><a href=\"#link-upstream\">Добавить ссылку на чистовик</a></li>\n<li><a href=\"#create-branch\">Создать ветку для нового задания</a></li>\n</ul>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2 id=\"-\">Привязать апстрим к локальному каталогу</h2>\n<p>После того, как репозитарий склонирован, необходимо привязать\nего к &quot;чистовику&quot;.</p>\n<p>Чтобы проверить, привязан ли локальный репозитарий к чистовику,\nдостаточно выполнить команду</p>\n<pre><code>git remote -v\n</code></pre><p>(См. <a href=\"#list-remotes\">список удалённых репозитариев</a>)</p>\n<p>Если в полученном выводе нет ссылок на репозитарии организации\n<code>htmlacademy-javascript</code>, необходимо привязать локальный репозитарий\nк удалённому репозитарию <code>htmlacademy-javascript</code>.</p>\n<p>Для этого нужно выполнить команду:</p>\n<pre><code>git remote add upstream "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.ssh : depth0)) != null ? stack1.upstream : stack1), depth0))
	    + "\n</code></pre>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h2 id=\"-\">Посмотреть полный список удалённых репозитариев</h2>\n<pre><code>git remote -v\n</code></pre>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2 id=\"-\">Создать ветку под задание</h2>\n<p>После того, как предыдущее задание было выполнено,\nизменения из апстрима были вытянуты,\nпереходим в ветку <code>master</code>:</p>\n<pre><code>git checkout master\n</code></pre><p>затем создаём новую ветку</p>\n<pre><code>git checkout -b "
	    + container.escapeExpression(((helper = (helper = helpers.branchName || (depth0 != null ? depth0.branchName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"branchName","hash":{},"data":data}) : helper)))
	    + "\n</code></pre>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h2 id=\"-\">Перейти в ветку задания</h2>\n<p>Если хочется временно перейти в ветку <code>master</code>, выполняем команду:</p>\n<pre><code>git checkout master\n</code></pre><p>Если нужно перейти в ветку задания, выполняем команду:</p>\n<pre><code>git checkout "
	    + container.escapeExpression(((helper = (helper = helpers.branchName || (depth0 != null ? depth0.branchName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"branchName","hash":{},"data":data}) : helper)))
	    + "\n</code></pre>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1 id=\"-\">Указать, какие файлы надо закомиттить</h1>\n<p>Используем команду</p>\n<pre><code>git add &lt;что надо добавить&gt;\n</code></pre><p>После <code>add</code> может быть:</p>\n<p><code>.</code> - если нужно добавить вообще все измененные/добавленные файлы</p>\n<p><code>build/</code> - имя каталога, внутри которого произошли изменения</p>\n<p><code>build/js/check.js</code> - имя файла, который был изменен</p>\n<p>Например:</p>\n<pre><code>git add src/\n</code></pre><p>Добавить все файлы, изменённые в каталоге <code>src</code>.</p>\n<pre><code>git add src/resize.js\n</code></pre><p>Добавить изменения только из файла <code>src/resize.js</code></p>\n<h2 id=\"-\">Что посмотреть дальше</h2>\n<ul>\n<li><a href=\"#cancel-changes\">Отменить изменения</a></li>\n<li><a href=\"#commit-staged\">Закомиттить добавленное</a></li>\n</ul>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1 id=\"-\">Отменить сделанные изменения</h1>\n<h2 id=\"-\">Если изменения не были добавлены в индекс</h2>\n<p>Просто откатываем состояние файла командой:</p>\n<pre><code>git checkout -- &lt;имя файла&gt;\n</code></pre><p>Например</p>\n<pre><code>git checkout src/resize.js\n</code></pre><h2 id=\"-git-add\">Если изменения уже были добавлены при помощи git add</h2>\n<p>Используем команду</p>\n<pre><code>git reset HEAD &lt;имя файла&gt;\n</code></pre><p>например</p>\n<pre><code>git reset HEAD src/resize.js\n</code></pre>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1 id=\"-\">Скомиттить добавленные файлы</h1>\n<p>Используем команду</p>\n<pre><code>git commit -m &#39;Что я изменил в этом комитте&#39;\n</code></pre><p>В результате комитта изменения, сделанные в рабочем каталоге\nбудут сохранены в локальном репозитарии. Чтобы изменения\nпопали из локального репозитария в форк, их необходимо\nв него <a href=\"#push-commits\">протолкнуть</a>.</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1 id=\"-\">Скомиттить все изменения</h1>\n<p>Используем команду</p>\n<pre><code>git commit -am &#39;Что было изменено в комитте&#39;\n</code></pre><p>Ключ <code>-am</code> на самом деле обозначает два ключа: <code>-a</code> - добавление всех изменений\nи <code>-m</code> - сообщение для комитта.</p>\n<h2 id=\"-\">Если передумали, можно</h2>\n<ul>\n<li><a href=\"#stage-files\">Добавить файлы по одному</a></li>\n<li><a href=\"#commit-staged\">Скомиттить добавленные файлы</a></li>\n</ul>\n<h2 id=\"-\">После комитта можно</h2>\n<ul>\n<li><a href=\"#push-commits\">Протолкнуть изменения в форк</a></li>\n</ul>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1 id=\"-\">Протолкнуть изменения в форк</h1>\n<p>Чтобы изменения из локального репозитария попали в форк,\nнаходясь в ветке <code>"
	    + alias4(((helper = (helper = helpers.branchName || (depth0 != null ? depth0.branchName : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"branchName","hash":{},"data":data}) : helper)))
	    + "</code>, выполняем команду:</p>\n<pre><code>git push origin "
	    + alias4(((helper = (helper = helpers.branchName || (depth0 != null ? depth0.branchName : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"branchName","hash":{},"data":data}) : helper)))
	    + "\n</code></pre><p>Если после такой команды нам потребовалось сделать ещё один пуш в эту же ветку можно попробовать более короткий вариант:</p>\n<pre><code>git push\n</code></pre><h2 id=\"-\">Что посмотреть</h2>\n<ul>\n<li><a href=\"#checkout-branch\">Как перейти в ветку</a></li>\n</ul>\n";
	},"useData":true});
